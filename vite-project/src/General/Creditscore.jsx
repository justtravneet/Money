        ...
        <div>
            <div className='grid sm:grid-cols-2 gap-[20px] sm:gap-8 mt-[40px]'>
                <div className='w-full h-[auto] '>
                    <div>
                        <p className='text-[28px] font-semibold sm:text-[30px] lg:text-[34px]'>Check your </p>
                        <p className='text-[28px] font-bold  sm:text-[30px] lg:text-[34px]'>credit score</p>
                        <p className='text-[28px] font-semibold  sm:text-[30px] lg:text-[34px]'>for free</p>
                    </div>
